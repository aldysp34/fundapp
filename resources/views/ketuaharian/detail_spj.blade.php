    ...
    <div class="container-fluid page__container">
                ...
                @endif
                    ...
                    <div class="card mb-lg-32pt">
                        <form action="{{route('ketua-harian.approval_spj', ['id' => $spj->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div>
                                <div class="card-header">
                                    <label class="mr-sm-2 form-label">APPROVAL SPJ</label>
                                </div>
                            </div>
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="custom-file">
                                    @if($spj->spj_file)
                                    <a href="{{ route('ketua-harian.download_spj', ['id' => $spj->id]) }}" class="chip chip-outline-primary">Lembar Pengajuan SPJ</a>
                                    @endif
                                    @if($spj->lembarVerifikasi)
                                    <a href="{{ route('ketua-harian.download_verifikasi_spj', ['id' => $spj->id]) }}" class="chip chip-outline-primary">Lembar Verifikasi</a>
                                    @endif
                                    @if($spj->spj_excel)
                                    <a href="{{ route('ketua-harian.download_excel', ['id' => $spj->id]) }}" class="chip chip-outline-primary">Lembar Rincian SPJ</a>
                                    @endif
                                ...
                                <div class="form-group">
                                <label class="form-label">Upload berkas approval</label>
                                <div class="custom-file">
                                    <input type="file"
                                            id="file"
